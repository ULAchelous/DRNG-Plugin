                        ...
                        builder -> builder
                                .base(DialogBase
                                        ...
                                        .inputs(List.of(
                                                ...
                                                DialogInput.text("content",500,Component.text("正文"),true,"",600, TextDialogInput.MultilineOptions.create(15,100)),//正文
                                        ...
                                        ,ActionButton.create(Component.text("确认")
                                                ...
                                                DialogAction.customClick(
                                                        (view,audience) -> {
                                                            ...
                                                            audience.sendMessage(Component.text(view.getText("time_limit")));
